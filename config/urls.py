...
from core.views import UserViewSet, OrganizationViewSet, OrganizationMemberViewSet, RegisterView, InviteMemberView, AcceptInviteView, RequestPasswordResetView, ConfirmPasswordResetView
...
urlpatterns = [
    ...
    path('api/auth/invite/accept/', AcceptInviteView.as_view(), name='invite_accept'),
